...
from .smf1101_base import ReprMixin, Base1101Da, DfhcbtsBase, DfhchnlBase, DfhcicsBase, DfhdataBase, DfhdestBase, \
...
class Smf1101Da(ReprMixin, Base1101Da, DfhcbtsBase, DfhchnlBase, DfhcicsBase, DfhdataBase, DfhdestBase, DfhdochBase,
                DfhfepiBase, DfhfileBase, DfhjourBase, DfhmappBase, DfhotelBase, DfhprogBase, DfhrmiBase, DfhsockBase,
                DfhstorBase, DfhsyncBase, DfhtaskBase, DfhtempBase, DfhtermBase, DfhwebbBase, DfhwebcBase):
    """The Smf1101Da class stores the daily Smf1101 record in the smf110_1_da table."""

    __tablename__ = "smf110_1_da"
