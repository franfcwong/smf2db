...
from .smf123_base import ReprMixin, Base12315m, DfhcbtsBase, DfhchnlBase, DfhcicsBase, DfhdataBase, DfhdestBase, \
...
class Smf110Smf12315m(ReprMixin, Base12315m, DfhcbtsBase, DfhchnlBase, DfhcicsBase, DfhdataBase, DfhdestBase,
                      DfhdochBase, DfhfepiBase, DfhfileBase, DfhjourBase, DfhmappBase, DfhotelBase, DfhprogBase,
                      DfhrmiBase, DfhsockBase, DfhstorBase, DfhsyncBase, DfhtaskBase, DfhtempBase, DfhtermBase,
                      DfhwebbBase, DfhwebcBase):
    """The Smf110Smf12315m class stores the 15-minutes Smf110Smf123 record in the smf110_123_15m table."""

    __tablename__ = "smf110_123_15m"
...
class Smf123RequestData15m(ReprMixin, Base12315m, Smf123RequestSummaryBase, DfhcbtsBase, DfhchnlBase, DfhcicsBase,
    ...
    """The Smf123RequestData15m class stores the 15-minutes Smf123RequestData record in the smf123_request_data_15m table."""

    __tablename__ = "smf123_request_data_15m"
    ...
    __table_args__ = (
        sa.PrimaryKeyConstraint(smf123_server_sysplex, smf123_sid, smf123_server_jobname, smf123_server_jobid,
                                datetime_15m, smf123s1_sor_identifier),
        sa.ForeignKeyConstraint(
            ['smf123_server_sysplex', 'smf123_sid', 'smf123_server_jobname', 'smf123_server_jobid', 'datetime_15m'],
            ['smf123_server_15m.smf123_server_sysplex', 'smf123_server_15m.smf123_sid',
             'smf123_server_15m.smf123_server_jobname', 'smf123_server_15m.smf123_server_jobid',
             'smf123_server_15m.datetime_15m']),
    )

    smf123_server_15m: so.Mapped['Smf123Server15m'] = so.relationship(back_populates='smf123_request_data_15ms',
                                                                      viewonly=True)


class Smf123Server15m(ReprMixin, Base12315m, Smf123ServerBase):
    """The Smf123Server15m class stores the 15-minutes Smf123Server record in the smf123_server_15m table."""

    __tablename__ = "smf123_server_15m"
    smf123_server_sysplex: so.Mapped[str] = so.mapped_column(sa.String(8), doc="Sysplex name (ECVTSPLX).")
    smf123_server_jobid: so.Mapped[str] = so.mapped_column(sa.String(8), doc="Job ID of the server (JSABJBID).")
    smf123_server_jobname: so.Mapped[str] = so.mapped_column(sa.String(8), doc="Job name of the server (JSABJBNM).")
    datetime_15m: so.Mapped[dt.datetime] = so.mapped_column(sa.DateTime, doc="The 15-minute interval of the record.")
    ...
    smf123_request_data_15ms: so.Mapped[List['Smf123RequestData15m']] = so.relationship(
        back_populates='smf123_server_15m', viewonly=True)
